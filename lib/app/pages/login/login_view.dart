...
class LoginView extends StatelessWidget {
 ...
 //  Controller _controller=Get.put(Controller(Get.put(Presenter(Get.put(AuthUseCase(Get.put(Repository())))))));
  @override
        ...
        return Container(
          decoration: const BoxDecoration(
            image: DecorationImage(
              fit: BoxFit.fill,
              image: NetworkImage('https://i.pinimg.com/originals/50/f8/29/50f829006ddab7a1f1616bc7483ccbbf.jpg'),
            ),
          ),
          child: Scaffold(
